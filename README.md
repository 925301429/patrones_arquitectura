...
> [!NOTE]
> 👍Un **patron arquitectonicos** es una solucion general y reutilizable a un programa comun en la arquitectura de  software
...
## INTRODUCCION
 El patrón Maestro / Esclavo se usa más comúnmente cuando se responde a los controles de la interfaz de usuario mientras se recopilan datos simultáneamente. Suponga que desea escribir una aplicación que mida y registre un voltaje que cambia lentamente una vez cada cinco segundos.
 # FUNCION
